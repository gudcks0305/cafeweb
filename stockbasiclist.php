            ...
            <div class="slogan">
               <?php
				 include_once('dbconn.php');
				   ...
				   echo "<TH>사용단위</TH><TH>적정재고량</TH><TH>발주</TH><TH>수정</TH><TH>삭제</TH>";
				   echo "</TR>";
				   
				   while($row = mysqli_fetch_array($ret)) {
					  echo "<TR>";
					  echo "<TD>", $row['0'], "</TD>";//stockid
					  ...
					  echo "<TD>", "<a href='orderstockinput.php?3=", $row['0'],"&stockname=", $row['1'], "'>발주</a></TD>";
					  echo "<TD>", "<a href='stockbasicupdate.php?0=", $row['0'], "'>수정</a></TD>";
