    ...
    <div class="bg">
            <div class="slogan">
               <?php
				   ...
				   $sql ="SELECT * FROM orderaccountTBL";
				   ...
				   if($ret) {
					   ...
					   echo "orderaccountTBL 데이터 조회 실패!!!"."<br>";
				   ...
				   echo "<TH>상호</TH><TH>거래처 번호</TH><TH>거래처 주소</TH><TH>관리자 이메일</TH><TH>관리자명</TH>";
				   echo "<TH>수정</TH><TH>삭제</TH></div>";
				   echo "</TR>";
				   
				   while($row = mysqli_fetch_array($ret)) {
					  echo "<TR>";
					  echo "<TD>", $row['0'], "</TD>";//orderaccoutName
					  echo "<TD>", $row['1'], "</TD>";//orderaccoutTelno
					  echo "<TD>", $row['2'], "</TD>";//orderaccountaddress
					  echo "<TD>", $row['3'], "</TD>";//orderaccountEmaddress
					  echo "<TD>", $row['4'], "</TD>";//orderaccountEmName
				
					 
					  echo "<TD>", "<a href='#'", $row['0'], "'>수정</a></TD>";
					  echo "<TD>", "<a href='#'", $row['0'], "'>삭제</a></TD>";
					  echo "</TR>";	  
				   }   
				   mysqli_close($con);
				   echo "</TABLE>"; 
				...
				?>
				<div class = "button">
					<button type="button" onClick="location.href='orderaccuntinput.php'">거래처 정보추가
