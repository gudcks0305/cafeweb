...
<html>
    ...
    <body>
        ...
        <div class="bg">
            <div class="slogan">
                <h1> 재고 기본정보</h1>
				<FORM METHOD="post"  ACTION="stockBasicinputresult.php">
					<table>
					<tr>
					<td>재고번호 : </td>
					...
					<tr>
						<td>재고유형 : </td>
						<td><INPUT TYPE ="text" NAME="stocktype"> </td>
					</tr>
					<tr>
						<td>재고보관유형 :</td>
						<td><INPUT TYPE ="text" NAME="stockKeeptype"> </td>
					</tr>
					<tr>
						<td>사용가능 일수 :</td>
						<td><INPUT TYPE ="text" NAME="stockableday"> </td>
					</tr>
					<tr>
						<td>사용단위 :</td>
						<td><INPUT TYPE ="text" NAME="stockbasicunit"></td>
					</tr>
					<tr>
						<td>적정재고량 :</td> 
						<td><INPUT TYPE ="number" NAME="stockapp"></td>
					</tr><br>
