    ...
    <div class="bg">
            <div class="slogan">
               <?php
				   ...
				   $sql ="SELECT s.stockid, sb.stockname, stockShelfLife , stockopendate ,s.stockamount,sb.stockbasicUnit
						FROM stockTBL s,stockbasicTBL sb
						WHERE s.stockid = sb.stockid
						group by stockid
						";
				   ...
				   echo "<TH>재고번호</TH><TH>재고명</TH><TH>유통기한</TH><TH>개봉일자</TH><TH>수량</TH><TH>단위</TH>";
				   echo "<TH>수정</TH></div>";
				   echo "</TR>";
				   ...
				   while($row = mysqli_fetch_array($ret)) {
					  ...
					  echo "<TD>", "<a href='stockupdate.php'>수정</a></TD>";
