            ...
            <div class="slogan">
               <?php
				 include_once('dbconn.php');
				   $sql ="SELECT *,stockbasicTBL.stockbasicunit FROM ordertbl,stockbasicTBL where ordertbl.orderstockid = stockbasicTBL.stockid";
				   ...
				   echo "<TABLE border=1>";
				   echo "<TR>";
				   echo "<TH>발주번호</TH><TH>발주날짜</TH><TH>발주 재고번호</TH><TH>발주 수량</TH><TH>단위</TH><TH>거래처</TH><th>입고여부</th>";
				   echo "<TH>수정</TH><TH>삭제</TH>";
				   echo "</TR>";
				   
				   while($row = mysqli_fetch_array($ret)) {
					  echo "<TR>";
					  echo "<TD>", $row['0'], "</TD>";//orderid
					  echo "<TD>", $row['1'], "</TD>";//orderdate
					  echo "<TD>", $row['2'], "</TD>";//orderstockid
					  echo "<TD>", $row['3'], "</TD>";//orderstockamount
					  echo "<TD>", $row['stockbasicunit'], "</TD>";//사용단위
					  echo "<TD>", $row['4'], "</TD>";//orderstockaccountname
					 ...
					 // echo "<TD>", $row['5'], "</TD>";//orderstockWhether
					
					 
					  echo "<TD>", "<a href='orderstockupdate.php?0=", $row['0'], "'>수정</a></TD>";
				...
				?>
				<div class = "button">
					<button type="button" onClick="location.href='orderstockinput.php'">발주
